...
var CanvasRendererComponent, Direction, KeyboardInputComponent, Kovas, Map, Player, Tile,
  ...
  Player.prototype.update = function() {
    ...
    if (this.nextMoveIn <= 0) {
      ...
      if (newPosition) {
        ...
        if (this.map.tileType(this.x, this.y) === Tile.food) {
          this.map.eatFood(this.x, this.y);
        }
